  ...
  return (
    <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
      <g id="Filled_outline" data-name="Filled outline">
        ...
        <path
          d="m24 10h1a0 0 0 0 1 0 0v6a0 0 0 0 1 0 0h-1a3 3 0 0 1 -3-3 3 3 0 0 1 3-3z"
          fill="#f9bb4b"
        />
        <path
          d="m42 10h1a0 0 0 0 1 0 0v6a0 0 0 0 1 0 0h-1a3 3 0 0 1 -3-3 3 3 0 0 1 3-3z"
          fill="#f9bb4b"
          transform="matrix(-1 0 0 -1 82 26)"
        />
        <path d="m25 3h14v4h-14z" fill="#5a6470" />
        <path
          d="m19 28-4 6-5-4h-4a2 2 0 0 0 -2 2 2 2 0 0 0 2 2h2l8 6 6-9z"
          fill="#ffd782"
        />
        <path d="m38 25h-12l-7 3 5 5v14h16v-14l5-5z" fill="#195c85" />
        <path
          d="m45 28 4 6 5-4h4a2 2 0 0 1 2 2 2 2 0 0 1 -2 2h-2l-8 6-6-9z"
          fill="#ffd782"
        />
        <path d="m28 47v4a3 3 0 0 1 -3 3h-1v7h8v-14z" fill="#32b1cc" />
        <path
          d="m24 47-5 2-3 5a2.19 2.19 0 0 0 1 3c2 1 4-3 4-3h4a3 3 0 0 0 3-3v-4z"
          fill="#f4f4e6"
        />
        <path d="m36 47v4a3 3 0 0 0 3 3h1v7h-8v-14z" fill="#53cfe0" />
        <path
          d="m40 47 5 2 3 5a2.19 2.19 0 0 1 -1 3c-2 1-4-3-4-3h-4a3 3 0 0 1 -3-3v-4z"
          fill="#f4f4e6"
        />
