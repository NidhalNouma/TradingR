...
export default function DnArrow(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 37.838 45.53">
      <g id="arrow_1_" data-name="arrow" transform="translate(-194.662 16.046)">
        <path
          id="Path_379"
          data-name="Path 379"
