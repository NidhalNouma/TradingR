...
function Paymentimg() {
  return (
    <svg height="90" viewBox="0 0 512 512" width="90">
      <linearGradient
        id="New_Gradient_Swatch_8"
        gradientTransform="translate(5.49 -77.255)"
      ...
      <linearGradient
        ...
        gradientTransform="translate(-40.029 30.64)"
        x1="143.029"
        x2="255.046"
        y1="192.36"
        y2="192.36"
      ...
      <linearGradient
        ...
        gradientTransform="translate(27.853 58.757)"
        x1="75.147"
        x2="187.163"
        y1="260.243"
        y2="260.243"
      ...
      <linearGradient
        ...
        gradientTransform="translate(87.735 90.189)"
        x1="7.265"
        x2="119.281"
        y1="316.811"
        y2="316.811"
      ...
      <g id="_22-mobile" data-name="22-mobile">
        <g id="linear_color" data-name="linear color">
          <rect
            ...
            height="225.054"
            rx="32"
            transform="matrix(.707 -.707 .707 .707 -59.647 144)"
            width="64"
            x="112"
            y="31.473"
          />
          <g id="color">
            ...
            />
            <path
              d="m384 16h-240a16 16 0 0 0 -16 16v39.956h272v-39.956a16 16 0 0 0 -16-16z"
              fill="url(#New_Gradient_Swatch_12)"
            />
            <path
              d="m128 480a16 16 0 0 0 16 16h240a16 16 0 0 0 16-16v-63.957h-272z"
          ...
          <rect
            ...
            height="128"
            rx="32"
            transform="matrix(.707 -.707 .707 .707 -118.144 160.775)"
            width="64"
            x="103"
            y="159"
          />
          <rect
            ...
            height="128"
            rx="32"
            transform="matrix(.707 -.707 .707 .707 -186.026 188.892)"
            width="64"
            x="103"
            y="255"
          />
